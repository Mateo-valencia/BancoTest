...
public class ActualizarClienteServiceTest {
    ...
    @Test
    public void shouldActualizarCliente(){
        ...
        List<Cliente> respuestaCliente = service.actualizarClientes(Collections.singletonList(cliente1));
    ...
    @Test
    public void shouldCrearClientesExceptionNoClienteId(){
        Cliente cliente = cliente1.toBuilder().clienteId(null).build();

        assertThrows(BusinessException.class,() -> service.actualizarClientes(Collections.singletonList(cliente)));
    }

    @Test
    public void shouldCrearClientesExceptionNoExisteCliente(){
        when(clienteOutPutPort.findByClienteId(anyString()))
                .thenReturn(Optional.empty());

        assertThrows(BusinessException.class,() -> service.actualizarClientes(Collections.singletonList(cliente1)));
    }
}